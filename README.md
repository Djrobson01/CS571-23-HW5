[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-c66648af7eb3fe8bc4f294546bfd86ef473780cde1dea487d3c4ff354943c9ae.svg)](https://classroom.github.com/online_ide?assignment_repo_id=10220097&assignment_repo_type=AssignmentRepo)
...
1. Assume that Badger Beats contains thousands of songs. How would you load and display the results in an efficient manner?
    ...
    If there were thousands of songs, I would use pagination to display the songs. I would separate the songs into 26 pages, one for every letter. Within each page, the user can scroll through every song by artists with the same letter.

2. Assume that Badger Beats contains thousands of songs. How would you help users narrow down their results?

    In order to help narrow down their results, I would provide a search functionality that would match on title or artists. I could provide further filtering, through faceted searches, that could filter by things such as year or genre.

3. What are three aspects of visual design that *you used* in your implementation of Badger Beats?
    - One visual design aspect I used was space. I used it between the cards that display the songs as well as the home page. Furthermore, I added some space to the cards, through padding, to ensure the button isn't hugging the bottom of the card.
    - Another visual design aspect I used was rhythm. With multiple cards following a specified pattern, there is a certain rhythm to the songs and favorite songs pages.
    - The final design element I used was balance. For most of the cards, I tried to ensure that the space between columns as well as the rows were even. This balances the spacing between the cards making it more pleasant to look at.

4. What are three aspects of visual design that *could be used* to improve your implementation of Badger Beats?
    - I believe the home page could use a focal point to draw a user in and make them want to look at songs and add them to their favorites. Currently, the main focus on the home page seems to be the paragraph, but overall, I think the focus should be getting to the music
    - I believe all of Badger Beats could be more colorful.
    - Lastly, I think the size of some things could be bigger. The 'Get Started Now!' button is a little small. Furthermore, the navbar seems a little small.
